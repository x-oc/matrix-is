...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidationExceptions(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ApiResponse<>(false, "Validation failed", errors, System.currentTimeMillis()));
    }

    @ExceptionHandler(SignatureException.class)
    public ResponseEntity<ApiResponse<Void>> handleSignatureException(SignatureException ex) {
        log.error("JWT signature error: ", ex);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiResponse.error("Corrupted JWT token"));
    }
